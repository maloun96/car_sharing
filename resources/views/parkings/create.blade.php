    ...
    @endif
      <form method="post" action="{{ route('parkings.store') }}">
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" name="parking_capacity"/>
          </div>
          <div class="form-group">
              <label for="parking_price">Parking Price:</label>
              <input type="text" class="form-control" name="parking_price"/>
          </div>
          <div class="form-group">
              <label for="parking_latitude">Parking Latitude:</label>
              <input type="text" class="form-control" name="parking_latitude"/>
          </div>
          <div class="form-group">
              <label for="parking_longitude">Parking Longitude:</label>
              <input type="text" class="form-control" name="parking_longitude"/>
          </div>
